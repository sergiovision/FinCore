...
#include <XTrade\IUtils.mqh>
   ...
   // #define Utils.Ask()    SymbolInfoDouble(_symbol,SYMBOL_Utils.Ask())
   // #define Utils.Bid()    SymbolInfoDouble(_symbol,SYMBOL_Utils.Bid())
      ...
      case  ORDER_TYPE_BUY:
        {
         ...
         if(!SL_check && suppressLogOutput == false)
            PrintFormat("For order %s   StopLoss=%.5f must be less than %.5f"+
                        " (Utils.Bid()=%.5f - SYMBOL_TRADE_STOPS_LEVEL=%d points)",
      ...
      case  ORDER_TYPE_SELL:
        {
         ...
         if(!SL_check && suppressLogOutput == false)
            PrintFormat("For order %s   StopLoss=%.5f must be greater than %.5f"+
                        " (Utils.Ask()=%.5f + SYMBOL_TRADE_STOPS_LEVEL=%d points)",
      ...
      case  ORDER_TYPE_BUY_LIMIT:
        {
         ...
         if(!check && suppressLogOutput == false)
            PrintFormat("Order %s #%d cannot be modified: Utils.Ask()-Open=%d points < SYMBOL_TRADE_FREEZE_LEVEL=%d points",
      ...
      case  ORDER_TYPE_SELL_LIMIT:
        {
         ...
         if(!check && suppressLogOutput == false)
            PrintFormat("Order %s #%d cannot be modified: Open-Utils.Bid()=%d points < SYMBOL_TRADE_FREEZE_LEVEL=%d points",
      ...
      case  ORDER_TYPE_SELL_STOP:
        {
         ...
         if(!check && suppressLogOutput == false)
            PrintFormat("Order %s #%d cannot be modified: Utils.Bid()-Open=%d points < SYMBOL_TRADE_FREEZE_LEVEL=%d points",
      ...
      case POSITION_TYPE_BUY:
        {
         ...
         if(!SL_check && suppressLogOutput == false)
            PrintFormat("Position %s #%d cannot be modified: Utils.Bid()-StopLoss=%d points"+
         ...
         if(!TP_check && suppressLogOutput == false)
            PrintFormat("Position %s #%d cannot be modified: TakeProfit-Utils.Bid()=%d points"+
                        " < SYMBOL_TRADE_FREEZE_LEVEL=%d points)",
      ...
      case POSITION_TYPE_SELL:
        {
         ...
         if(!SL_check && suppressLogOutput == false)
            PrintFormat("Position %s cannot be modified: StopLoss-Utils.Ask()=%d points"+
                        " < SYMBOL_TRADE_FREEZE_LEVEL=%d points)",
                        EnumToString(pos_type),(int)((sl-Utils.Ask())/_point),freeze_level);
         TP_check=(tp == 0) ? true: (Utils.Ask()-tp>freeze_level*_point);
         if(!TP_check && suppressLogOutput == false)
            PrintFormat("Position %s cannot be modified: Utils.Ask()-TakeProfit=%d points"+
                     " < SYMBOL_TRADE_FREEZE_LEVEL=%d points)",
      ...
      case  OP_BUYLIMIT:
        {
         ...
         check=((Utils.Ask()-price)>freeze_level*_point);
         if(!check && suppressLogOutput == false)
            PrintFormat("Order OP_BUYLIMIT #%d cannot be modified: Utils.Ask()-Open=%d points < SYMBOL_TRADE_FREEZE_LEVEL=%d points",
      ...
      case  OP_SELLLIMIT:
        {
         ...
         check=((price-Utils.Bid()())>freeze_level*_point);
         if(!check && suppressLogOutput == false)
            PrintFormat("Order OP_SELLLIMIT #%d cannot be modified: Open-Utils.Bid()=%d points < SYMBOL_TRADE_FREEZE_LEVEL=%d points",
      ...
      case  OP_BUYSTOP:
        {
         ...
         check=((price-Utils.Ask())>freeze_level*_point);
         if(!check && suppressLogOutput == false)
            PrintFormat("Order OP_BUYSTOP #%d cannot be modified: Utils.Ask()-Open=%d points < SYMBOL_TRADE_FREEZE_LEVEL=%d points",
      ...
      case  OP_SELLSTOP:
        {
         ...
         check=((Utils.Bid()-price)>freeze_level*_point);
         if(!check && suppressLogOutput == false)
            PrintFormat("Order OP_SELLSTOP #%d cannot be modified: Utils.Bid()-Open=%d points < SYMBOL_TRADE_FREEZE_LEVEL=%d points",
      ...
      case  OP_BUY:
        {
         ...
         if(!TP_check && suppressLogOutput == false)
            PrintFormat("Order OP_BUY %d cannot be modified: TakeProfit-Utils.Bid()=%d points < SYMBOL_TRADE_FREEZE_LEVEL=%d points",
      ...
      case  OP_SELL:
        {
         ...
         if(!TP_check && suppressLogOutput == false)
            PrintFormat("Order OP_SELL %d cannot be modified: Utils.Ask()-TakeProfit=%d points < SYMBOL_TRADE_FREEZE_LEVEL=%d points",
